        ...
        <div className="mt-6">
          <button
            onClick={async () => {
              ...
              //   connection,
              //   new PublicKey("DRib9wnU9JBpERP2JWrxPxAoHnSvwjV8eBrSh2LUX8qd") // The platform fee account owner
              // );
              ...
              const accountPublicKey = new PublicKey(
                "9uEB7gkK2HU19PXuwqL7Uo2Ew38vkWPUENC44EQNidPT"
              );

              const feeAccounts = await solana.getTokenAccountsByOwner(
                accountPublicKey,
                {
              ...
              window.Jupiter.init({
                endpoint:
                  "<RPC>",
                platformFeeAndAccounts: { feeBps: 100, feeAccounts },
              });
            }}
          >
            Launch Terminal
